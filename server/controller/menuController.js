module.exports = {
    ...
    addItem:(req,res,next)=>{
        ...
        dbInstance
            .createItemBySection([section_id,item_name,item_description,item_image,item_price])
            .then(item=>{res.status(200).send(item)})
            .catch(e =>console.log(e));
    },
    updateItem:(req,res,next)=>{
        const dbInstance = req.app.get("db");
        const { item_id, item_name, item_description, item_image, item_price } = req.body;
        dbInstance
